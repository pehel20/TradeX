        ...
        <div className="container mt-5">
          <div className="row">
            ...
            <div className="col-6 mt-5">
               <h4 className="text-muted">Free and open market education</h4>
               ...
               <a href="" className=""style={{textDecoration:"none"}}>Varsity <i class="fas fa-arrow-right"></i></a>
               ...
               <a href="" className=""style={{textDecoration:"none"}}>TradingQ&A <i class="fas fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
     );
